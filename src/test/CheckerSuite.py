...
class CheckerSuite(unittest.TestCase):
    ...
    def test3(self):
        ...
        main: function void() {
            a: array [2, 3] of integer = {{4,4,4},{4,4,8+7}, {1,1,1}};
        }"""
        expect = "Type mismatch in Variable Declaration: VarDecl(a, ArrayType([2, 3], IntegerType), ArrayLit([ArrayLit([IntegerLit(4), IntegerLit(4), IntegerLit(4)]), ArrayLit([IntegerLit(4), IntegerLit(4), BinExpr(+, IntegerLit(8), IntegerLit(7))]), ArrayLit([IntegerLit(1), IntegerLit(1), IntegerLit(1)])]))"
    ...
    def test7(self):
        ...
        main: function void() {
            a: array [1, 3] of integer = Ha();
        }"""
        expect = "Type mismatch in Variable Declaration: VarDecl(a, ArrayType([1, 3], IntegerType), FuncCall(Ha, []))"
    ...
    def test19(self):
        ...
        """
        expect = "Type mismatch in statement: CallStmt(printBoolean, FuncCall(foo, [Id(a)]))"
    ...
    def test24(self):
        ...
        """
        expect = "Type mismatch in statement: ReturnStmt(FloatLit(0.0003))"
    ...
    def test37(self):
        ...
        foo: function auto() {}
        """
        expect = "Type mismatch in statement: CallStmt(printBoolean, Id(a))"
    ...
    def test41(self):
        ...
        foo: function auto() {}
        """
        expect = "Type mismatch in statement: CallStmt(printBoolean, FuncCall(foo, []))"
    ...
    def test55(self):
        ...
        """
        expect = "Type mismatch in expression: BinExpr(>, ArrayCell(a, [IntegerLit(1), IntegerLit(0)]), BooleanLit(True))"
    ...
    def test60(self):
        ...
        """
        expect = "Type mismatch in Variable Declaration: VarDecl(b, BooleanType, Id(a))"
    ...
    def test70(self):
        ...
        foo: function auto() {}
        """
        expect = "Type mismatch in Variable Declaration: VarDecl(a, BooleanType, FuncCall(Ha, [FuncCall(foo, [])]))"
    ...
    def test72(self):
        input = """
            A : function void(a : integer, b : auto) {
